...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("contact@evanmse.com");
    setCopied(true);
  }
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-8">
                {["Html", "Css", "Typescript"].map((item) => (
                  <span key={item} className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-100 rounded-lg text-center bg-[#10132E]">
                   {item}
                  </span>
              ))}
